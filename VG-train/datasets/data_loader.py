...
class TransVGDataset(data.Dataset):
    ...
    def __init__(self, data_root, split_root='data', dataset='referit',  
        ...
        dataset_path = osp.join(self.split_root, self.dataset)  # data/unc
        # 'unc': {
        #     'splits': ('train', 'val', 'trainval', 'testA', 'testB'),  <---
        #     'params': {'dataset': 'refcoco', 'split_by': 'unc'}
        # },
        ...
        for split in splits:
            ...
            imgset_path = osp.join(dataset_path, imgset_file)  # data/unc/unc_train.pth
