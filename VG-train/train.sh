...
python -m torch.distributed.launch --nproc_per_node=1 --use_env train.py --batch_size 4 --aug_crop --aug_scale --aug_translate --bert_enc_num 12 --vl_enc_layers 6 --dataset unc --max_query_len 20 --output_dir outputs/refcoco_vit_base20x20 --epoch 90 --imsize 320 --resume checkpoint.pth
